...
connection.onmessage = (event) => {
  ...
  // moveCursorToEnd(document.querySelector('#content'));
  // document.querySelector('#content').focus();
  cursorManager.setEndOfContenteditable(document.querySelector('#content'));
};

document.querySelector('#content').addEventListener('input', (event) => {
  // event.preventDefault();
  let content = document.querySelector('#content').innerHTML;
  connection.send(content);//send updated content to websocket
});
